...
static constexpr char EXPLOSION_SOUND_3[] = "Assets/Sounds/explosion3.ogg";
static constexpr char EXPLOSION_SOUND_4[] = "Assets/Sounds/explosion4.ogg";
...
void LevelSoundSystem::Init(const std::string& levelMusic)
{
    ...
    Registry.emplace<Sound>(BallDestroyedSound , Mix_LoadWAV(EXPLOSION_SOUND_3));
    Registry.emplace<Sound>(BrickDestroyedSound, Mix_LoadWAV(EXPLOSION_SOUND_4));
